//Feito no Visual Studio Code (VS Code)
...
public class Soluções{
    public static void main(String[] args){
        ...
        if(escolha.equals("Concentração Comum") || escolha.equals("C")){
            double m1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'm1'", "Inserção", JOptionPane.PLAIN_MESSAGE));
            double V = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'V' em litros", "Inserção", JOptionPane.PLAIN_MESSAGE));
            double C = m1/V;
        ...
        if(escolha.equals("Título") || escolha.equals("T")){
            double m1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'm1'", "Inserção", JOptionPane.PLAIN_MESSAGE));
            double m2 = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'm2'", "Inserção", JOptionPane.PLAIN_MESSAGE));
            double T = m1/(m1+m2);
            double Tp = T*100;
        ...
        if(escolha.equals("Molaridade") || escolha.equals("Mr")){
            ...
            if(escolhaMr.equals("Fórmula 1") || escolhaMr.equals("1") || escolhaMr.equals("n1/V")){
                double n1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'n1'", "Inserção", JOptionPane.PLAIN_MESSAGE));
                double V = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'V' em litros", "Inserção", JOptionPane.PLAIN_MESSAGE));
                double Mr1 = n1/V;
        ...
        if(escolha.equals("Fração molar") || escolha.equals("X")){
            ...
            if(fração.equals("Fração molar do soluto") || fração.equals("X1")){
                ...
                if(escolhaX1.equals("Fórmula 1") || escolhaX1.equals("1") || escolhaX1.equals("n1/n")){
                    double n1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'n1'", "Inserção", JOptionPane.PLAIN_MESSAGE));
                    double n2 = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'n2'", "Inserção", JOptionPane.PLAIN_MESSAGE));
                    double X1a = n1/(n1+n2);
        ...
        if(escolha.equals("Molalidade") || escolha.equals("W")){
            ...
            if(escolhaW.equals("Fórmula 1") || escolhaW.equals("1") || escolhaW.equals("n1/m2")){
                ...
                double m2 = Double.parseDouble(JOptionPane.showInputDialog(null, "Insira o valor de 'm2'", "Inserção", JOptionPane.PLAIN_MESSAGE));
                double W_1 = n1/m2;
                JOptionPane.showMessageDialog(null, "O valor da fração molar do soluto é: "+W_1+" mol/Kg", "Resultado", JOptionPane.PLAIN_MESSAGE);}   
